...
rm -f /usr/bin/NVDARemoteServer /usr/bin/NVDARemoteCertificate /usr/bin/NVDARemoteUninstall /usr/share/man/man1/NVDARemoteServer.1.gz /usr/share/man/man1/NVDARemoteUninstall.1.gz /usr/share/man/man1/NVDARemoteCertificate.1.gz /var/log/NVDARemoteServer.log /etc/NVDARemoteServer.conf /usr/share/man/man5/NVDARemoteServer.conf.5.gz
