...
mkdir -p nvda-remote-server_1.5/usr/share/man/man5
#copy files
...
cp ../manual/NVDARemoteServer.conf.5 nvda-remote-server_1.5/usr/share/man/man5
...
gzip -n -9 nvda-remote-server_1.5/usr/share/man/man5/NVDARemoteServer.conf.5
...
chmod -x nvda-remote-server_1.5/usr/share/man/man5/NVDARemoteServer.conf.5.gz
