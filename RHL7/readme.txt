...
4. Copy daemon.py, server.py, LICENSE, NVDARemoteServer, NVDARemoteServer.1 (manual), NVDARemoteServer.service and server.pem into ~/rpmbuild/SOURCES/NVDARemoteServer-1.2, creating the directory if it doesn't exist
