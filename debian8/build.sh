...
cp ../systemd/NVDARemoteServer.sysusers nvda-remote-server_$VERSION/usr/lib/sysusers.d/NVDARemoteServer.conf
...
chmod -x nvda-remote-server_$VERSION/usr/lib/sysusers.d/NVDARemoteServer.conf
