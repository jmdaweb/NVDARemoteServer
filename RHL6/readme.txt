...
4. Copy daemon.py, server.py, LICENSE, NVDARemoteServer, NVDARemoteServer.1 (manual), NVDARemoteServerd and server.pem into ~/rpmbuild/SOURCES/NVDARemoteServer-1.0, creating the directory if it doesn't exist
