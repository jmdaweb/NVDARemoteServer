...
4. Copy daemon.py, server.py, NVDARemoteServer, NVDARemoteServerd and server.pem into ~/rpmbuild/SOURCES/NVDARemoteServer-1, creating the directory if it doesn't exist
