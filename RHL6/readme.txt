...
4. Copy daemon.py, server.py, LICENSE, NVDARemoteServer, NVDARemoteServer.1 (manual), NVDARemoteCertificate.1 (manual), NVDARemoteCertificate, NVDARemoteServerd and server.pem into ~/rpmbuild/SOURCES/NVDARemoteServer-1.4, creating the directory if it doesn't exist
