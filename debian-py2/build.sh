...
mkdir -p nvda-remote-server_$VERSION/usr/lib/systemd/system
#copy files
cp ../NVDARemoteCertificate ../NVDARemoteCertificate-letsencrypt ../systemd-py2/NVDARemoteServer nvda-remote-server_$VERSION/usr/bin
...
cp ../systemd-py2/NVDARemoteServer.service nvda-remote-server_$VERSION/usr/lib/systemd/system
...
chmod -x nvda-remote-server_$VERSION/usr/lib/systemd/system/NVDARemoteServer.service
